...
const { Commons, Table, Quote, List, CodeBlock } = require("./tokenizer")
...
module.exports = class Lexer {
  ...
  runCurrLineLexer() {
    ...
    if (CodeBlock.isOfType(this.#lines, this.#cursor, this.#currLineIndent)) return this.runCodeBlockLexer()
    if (Table.isOfType(this.#lines, this.#cursor, this.#currLineIndent)) return this.runTableLexer()
  ...
  runParagraphLexer() {
    if (this.#lastLexerItem && this.#lastLexerItem.type === TOKENS.PARAGRAPH) {
