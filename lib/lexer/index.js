...
export class Lexer {
	...
	#runCurrLineLexer() {
		...
		if (Commons.testHrLine(this.#currLine)) return this.#runHrLineLexer()
		if (Commons.testComment(this.#currLine)) return this.#runCommentLexer()
		if (Commons.testImage(this.#currLine)) return this.#runImageLexer()
		if (Commons.testHeading(this.#currLine)) return this.#runHeadingLexer()
